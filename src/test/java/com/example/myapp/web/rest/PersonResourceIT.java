...
import com.example.myapp.domain.Person;
...
class PersonResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "o@vwbrZ.OGED";
    private static final String UPDATED_EMAIL = "CbI@T.MeXv";
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().address(DEFAULT_ADDRESS).email(DEFAULT_EMAIL).password(DEFAULT_PASSWORD).name(DEFAULT_NAME);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().address(UPDATED_ADDRESS).email(UPDATED_EMAIL).password(UPDATED_PASSWORD).name(UPDATED_NAME);
        return person;
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.address(UPDATED_ADDRESS).email(UPDATED_EMAIL).password(UPDATED_PASSWORD).name(UPDATED_NAME);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.email(UPDATED_EMAIL).password(UPDATED_PASSWORD);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.address(UPDATED_ADDRESS).email(UPDATED_EMAIL).password(UPDATED_PASSWORD).name(UPDATED_NAME);
